					...
					?>
							<tr class="table">
								...
								<td>
									...
									<? echo $val['quantity'] ?>
									<a href="/cart_add.php?op=sub&id=<? echo $id ?>"><button>-</button></a>
									<a href="/cart_add.php?op=add&id=<? echo $id ?>"><button>+
								<td><a href="/cart_add.php?op=del&id=<? echo $id ?>">remove</a></td>
							</tr>
					<? }
					}
					?>
